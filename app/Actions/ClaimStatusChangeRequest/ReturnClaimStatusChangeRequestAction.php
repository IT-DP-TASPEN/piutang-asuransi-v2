...
class ReturnClaimStatusChangeRequestAction
{
    ...
    public function handle(ClaimStatusChangeRequest $claimStatusChangeRequest, User $user, ?string $notes = null): ClaimStatusChangeRequest
    {
        ...
        if (! $user->can('returnRequest', $claimStatusChangeRequest)) {
            throw ValidationException::withMessages([
                'permission' => 'Only authorized approvers can return this claim status update.',
            ]);
        }
