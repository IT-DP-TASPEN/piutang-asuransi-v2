    ...
    public function run(): void
    {
        ...
        $permissions = collect($subjects)
            ...
            ->merge([
                ...
                'ReconcileEarlyTerminationTopUp:InsuranceReceivable',
                ...
                'Retry:ReceivablePaymentRequest',
        ...
        $centralViewPermissions = [
            ...
            'ViewAny:InsuranceReceivableInstallmentRepayment',
            'View:InsuranceReceivableInstallmentRepayment',
            'ViewAny:ReceivablePayment',
            'View:ReceivablePayment',
            'ViewAny:ReceivablePaymentRequest',
            'View:ReceivablePaymentRequest',
