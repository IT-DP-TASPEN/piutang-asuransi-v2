...
class InsuranceCompanySeeder extends Seeder
{
    public function run(): void
    {
        $companies = [
            ...
            ['name' => 'NASIONAL LIFE', 'claim_type' => 'ajk', 'ckpn_weight' => '50', 'legal_name' => 'PT ASURANSI JIWA NASIONAL', 'letter_recipient_name' => 'PT ASURANSI JIWA NASIONAL', 'letter_recipient_address' => 'Gedung Menara Jamsostek, Menara Utara Lt. 3A, Jl. Jenderal Gatot Subroto No. 38, Jakarta Selatan 12710'],
            ['name' => 'HEKSA', 'claim_type' => 'ajk', 'ckpn_weight' => '0.5', 'legal_name' => 'PT HEKSA SOLUTION INSURANCE', 'letter_recipient_name' => 'PT HEKSA SOLUTION INSURANCE', 'letter_recipient_address' => 'Satrio Tower, 8th Floor, Jl. Prof. DR. Satrio Kav. C4, Kuningan Timur, Setiabudi, Jakarta Selatan 12950'],
            ['name' => 'GIB RELIANCE', 'claim_type' => 'ajk', 'ckpn_weight' => '0.5', 'legal_name' => 'PT ASURANSI JIWA RELIANCE INDONESIA', 'letter_recipient_name' => 'PT GLOBAL INSURANCE BROKER', 'letter_recipient_address' => 'Jl. Senopati No.21, Kebayoran Baru, Jakarta Selatan 12190'],
            ['name' => 'ABB', 'claim_type' => 'ajk', 'ckpn_weight' => '50', 'legal_name' => 'PT ASURANSI BHAKTI BHAYANGKARA', 'letter_recipient_name' => 'PT ASURANSI BHAKTI BHAYANGKARA', 'letter_recipient_address' => 'Ruko Mataram Plaza, Jl. MT. Haryono, Jagalan, Kec. Semarang Tengah, Kota Semarang, Jawa Tengah 50613'],
